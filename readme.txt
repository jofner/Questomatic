...
Questomatic can do some work for you.

Questomatic is small addon which can auto accept and auto finish quests for you:
...
Questomatic Config and commands

There is two ways to config Questomatic. Config dialog - press ESC > Interface > AddOns > Questomatic, or chat commands:

    /qm - Show Settings
    /qm toggle - Enable/Disable Questomatic
...
=========================================================================================
Questomatic on Curse: http://wow.curse.com/downloads/wow-addons/details/questomatic.aspx
Questomatic on CurseForge: http://wow.curseforge.com/addons/questomatic/
Questomatic on GitHub: http://github.com/risky/Questomatic